...
class StreetSnapEditor extends BaseController {
	...
	public function showStarter() {
		...
		return View::make('front.streetsnap.new.starter', ViewData::get());
	}
	...
	public function showEditor($id=null) {
		...
		if(empty($snap)) {
			...
			$snap->status='draft';
			$snap->save();
			return Redirect::to(action('StreetSnapEditor@showEditor', $snap->id));
		}
		...
		if($snap) {
			...
			return View::make('front.streetsnap.new.editor', ViewData::get());
		} else {
