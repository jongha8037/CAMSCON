...
@section('content')
	...
	<p>
	이 약관은 주식회사 캠스콘 ("회사" 또는 "네이버")이 제공하는 네이버 및 네이버 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
	</p>
	...
	<ol>
		<li>"회사"는 이 약관의 내용을 "회원"이 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다.
	...
	<ol>
		<li>"회원"이 "서비스" 내에 게시한 "게시물"의 저작권은 해당 게시물의 저작자와 "회사"에게 공동으로 귀속됩니다.</li>
	...
	<ol>
		...
		<li>본 조에 따른 세부절차는 "정보통신망법" 및 "저작권법"이 규정한 범위 내에서 "회사"가 정한 "게시중단요청서비스"에 따릅니다. <br />- 게시중단요청서비스 : http://help.naver.com/claim_main.asp</li>
	</ol>
	...
	<ol>
		<li>이 약관은 2014년 9월 23일부터 적용됩니다.</li>
	</ol>
</div>
@stop