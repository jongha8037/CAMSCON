...
@section('content')
	...
	<p>
	이 약관은 주식회사 캠스콘 ("회사" 또는 "캠스콘")이 제공하는 캠스콘 및 캠스콘 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
	</p>
	...
	<ol>
		<li>"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 캠스콘 및 캠스콘 관련 제반 서비스를 의미합니다.</li>
	...
	<ol>
		...
		<li>본 조에 따른 세부절차는 "정보통신망법" 및 "저작권법"이 규정한 범위 내에서 "회사"가 정한 규정에 따릅니다.</li>
	</ol>
