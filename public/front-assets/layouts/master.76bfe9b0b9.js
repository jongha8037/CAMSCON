...
$(document).ready(function() {
	...
	//Content protection
	$(document).on('contextmenu', 'img', null, function() {return false;});
	$(document).on('dragstart', 'img', null, function() {return false;});
	$(document).on('selectstart', 'img', null, function() {return false;});
});//document.ready()